...
namespace Gaskellgames.AudioController
{
    ...
    public class SoundEffect : MonoBehaviour
    {
        ...
        [SerializeField, RequiredField] private AudioMixerGroup mixerMaster;
        [SerializeField, RequiredField] private AudioMixerGroup mixerMusic;
        [SerializeField, RequiredField] private AudioMixerGroup mixerSoundFX;
        [SerializeField, RequiredField] private AudioMixerGroup mixerEnvironment;
        [SerializeField, RequiredField] private AudioMixerGroup mixerMenuUI;
        ...
        [SerializeField, RequiredField] private AudioMixerGroup audioMixerGroup;
