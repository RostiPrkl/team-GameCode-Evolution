...
namespace Gaskellgames.AudioController
{
    ...
    public class EditorSoundManager : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            // banner
            Texture banner = (Texture)AssetDatabase.LoadAssetAtPath("Assets/Gaskellgames/Audio Controller/Editor/Icons/inspectorBanner_AudioController.png", typeof(Texture));
