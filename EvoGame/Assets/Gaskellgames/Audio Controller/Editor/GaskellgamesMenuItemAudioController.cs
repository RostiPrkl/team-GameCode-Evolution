...
namespace Gaskellgames.AudioController
{
    public class GaskellgamesMenuItemAudioController : GaskellgamesMenuItem
    {
        ...
        private const string GaskellgamesGameObjectMenu_AudioController = GaskellgamesGameObjectMenu + "/Audio Controller";

        [MenuItem(GaskellgamesGameObjectMenu_AudioController + "/Sound Manager", false, 10)]
        ...
        [MenuItem(GaskellgamesGameObjectMenu_AudioController + "/Sound Manager", true, 10)]
        ...
        [MenuItem(GaskellgamesGameObjectMenu_AudioController + "/Sound Controller", false, 10)]
        ...
        [MenuItem(GaskellgamesGameObjectMenu_AudioController + "/Sound Controller", true, 10)]
        ...
        [MenuItem(GaskellgamesGameObjectMenu_AudioController + "/3D Sound Effect", false, 25)]
